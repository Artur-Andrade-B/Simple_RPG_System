...
class person:
    def __init__(self, name, hp, mp, atk, df, magic, items):
        ...
        self.magic = magic
        self.items = items
        self.actions = [bcolors.FAIL + "Atack" + bcolors.ENDC, bcolors.OKBLUE + "Magic" + bcolors.ENDC, bcolors.WARNING
                        + "Items" + bcolors.ENDC]
        self.name = name
    ...
    def get_stats(self):
        ...
        if self.hp <= self.maxhp / 2:
            hp_bar = bcolors.WARNING + hp_bar + bcolors.ENDC
    ...
    def get_enemy_stats(self):
        ...
        print(bcolors.BOLD + str(self.name), "       " + hp_string + " | " + bcolors.FAIL +
              hp_bar + bcolors.ENDC +"|   ")
